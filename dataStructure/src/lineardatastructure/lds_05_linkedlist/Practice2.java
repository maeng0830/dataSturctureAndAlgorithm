package lineardatastructure.lds_05_linkedlist;// Practice2
// Palindrome 연결 리스트
...
public class Practice2 {
    ...
    public static void main(String[] args) {
        ...
        linkedList.addData(3);
        linkedList.addData(1);
        System.out.println(checkPalindrome(linkedList)); // true
        ...
        linkedList2.addData(5);
        linkedList2.addData(3);
        System.out.println(checkPalindrome(linkedList2)); // true
        ...
        linkedList3.addData(1);
        System.out.println(checkPalindrome(linkedList3)); // false
